...
<title>News Updates - CebuaKnows</title>
<!-- Online Bootstrap -->
...
<!-- News Section -->
		<section class="container my-4" id="news">
			<h1 class="text-center mb-4"><strong>Latest News and Updates</strong></h1>
			<!-- News Items -->
			<div class="row g-4">
				<!-- News Item 1 -->
				<div class="col-md-6 col-lg-4">
					<div class="card h-100 shadow-sm"> <img src="img/assets/magellan1.jpg" class="card-img-top" alt="Historical Site 1">
						<div class="card-body">
				...
				<!-- News Item 2 -->
				<div class="col-md-6 col-lg-4">
					<div class="card h-100 shadow-sm"> <img src="img/assets/image1.jpg" class="card-img-top" alt="Historical Site 2">
						<div class="card-body">
				...
				<!-- News Item 3 -->
				<div class="col-md-6 col-lg-4">
					<div class="card h-100 shadow-sm"> <img src="img/assets/image2.jpg" class="card-img-top" alt="Historical Site 3">
						<div class="card-body">
