		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<a href="ContentList.php" type="button" class="btn-close"></a>
			  </div>
			  <div class="modal-body">
				<form action="ContentList.php" method="post">
				  <div class="mb-3">
				  ...
				  <div class="mb-3">
					...
					<div class="form-text">This message will be relayed to the Creator or the Historian only depending on the status.</div>
				  </div>
				  <div class="mb-3">
		...
		<br>
			<table id="example" class="table table-striped nowrap  border shadow" style="width:100%">
				...
				<tbody>
					...
					<?php
						$sql = "select * from content where status = 'PENDING'";
								...
								echo '
									<tr>
										...
										<td style="display:flex;" >
											<a class="btn btn-success" style="text-decoration:none;color:white;" href="historical_site-admin.php?contentId='.$row['content_id'].'"><i class="fas fa-eye"></i></a>
											<a class="btn btn-primary" style="text-decoration:none;color:white;" href="ContentList.php?get_contentid='.$row['content_id'].'"><i class="fas fa-comment"></i></a>	
