    ...
    <body>
		...
		<div class="row justify-content-center align-items-center p-2">
			<div class="col-md-6 mx-auto">
				<form action="dashboard-admin.php" method="post" class="input-group">
										...
										<div class="card mb-4 box-shadow">
											...
											<div class="card-body">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="btn-group">
														<a href="historical_site-admin.php?contentId='. $row['content_id'].'" class="btn btn-sm btn-outline-primary">View</a>
													</div>
							...
							echo '
										...
										<div class="card mb-4 box-shadow">
											...
											<div class="card-body">
												...
												<div class="d-flex justify-content-between align-items-center">
													<div class="btn-group">
														<a href="historical_site-admin.php?contentId='. $row_pagination['content_id'].'" class="btn btn-sm btn-outline-primary">View</a>
													</div>
