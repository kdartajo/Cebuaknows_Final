    ...
    <body>
		...
		<div class="p-3 mb-4 bg-light rounded-3">
		  <div class="container-fluid py-5 text-center"> <!-- Added text-center class here -->
			<h1 class="display-5 fw-bold"><i class="fas fa-medal"></i> Leaderboards</h1>
			<p class="col-md-8 fs-4 mx-auto"> <!-- Added mx-auto to center the text block -->
			  Welcome to the Leaderboards page! Here, you can track the top performers in various content quizzes.
			  See how you rank against others, based on scores.
			  Compete, improve, and aim for the top spot!
			</p>
		  </div>
		</div>
		...
		<div class="container">
			<div class="row justify-content-center align-items-center">
			  <?php
					$check_stmt = $conn->prepare("select COUNT(quiz_leaderboard.user_id) as quizTakers, quiz_leaderboard.quiz_id, content_title, quiz_title, content_id, image from quiz_leaderboard 
												INNER JOIN quiz ON quiz_leaderboard.quiz_id = quiz.quiz_id 
												INNER JOIN content ON content.quiz_id = quiz.quiz_id
					...
					if($check_result->num_rows > 0){
						...
						while($row_leader = mysqli_fetch_assoc($check_result)){
							echo '
										...
										<h5 class="card-title p-2">'.$row_leader['content_title'].'</h5>
										<div class="card mb-4 box-shadow">
											<img class="card-img-top" src="'.$row_leader['image'].'" alt="Card image cap">
											<div class="card-body">
												<h5 class="card-title">'.$row_leader['quiz_title'].'</h5>
												
												<div class="d-flex justify-content-between align-items-center">
													<div class="btn-group">
														<a href="leaderboard.php?quiz_id='. $row_leader['quiz_id'].'" class="btn btn-sm btn-outline-primary">View</a>
													</div>
													<small class="text-muted">Quiz Takers: '.$row_leader['quizTakers'].'</small>
												</div>
											</div>
										</div>
									</div>
