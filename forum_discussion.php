    ...
    <body>
        ...
        <div>
			<section class="banner">
				<img src="img/land-img/banner.png" class="img-fluid" alt="Banner">
			</section>
			<br>
			<br>
			<br>
		...
		<div class="container">
				...
				<div>
					Welcome to Forums
					<button type="button" data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-primary">Create Forum</button>
				</div>
				<br>
										...
										<div class="card-body">
										  ...
										  <div class="d-flex justify-content-between align-items-center">
											<div class="btn-group">
											  ...
											  <a  href="forum_page.php?forum_id='.$row['forum_id'].'" class="btn btn-sm btn-outline-primary"><i class="fas fa-newspaper"></i> View Forum</a>
