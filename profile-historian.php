					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="card mb-4 shadow-sm">
								<div class="card-body text-center"> <img src="<?php echo $row['profile_picture'] ?>" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
									<h5 class="my-3"><?php echo $row['username'] ?></h5>
									<!--<p class="text-muted mb-1">Full Stack Developer</p>-->
									<p class="text-muted mb-4">
										<?php echo $row['address'] ?>
									</p>
									<div class="d-flex justify-content-center mb-2"> <a type="button" class="btn btn-primary" href="profile-edit-historian.php"><i class="fas fa-edit"></i></a> </div>
								</div>
							</div>
