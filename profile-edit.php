					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card shadow-sm">
							<div class="card-body text-center">
								<img src="<?php echo $row['profile_picture']; ?>" alt="avatar" class="rounded-circle img-fluid mb-3" style="width: 150px; height: 150px; object-fit: cover;">
							...
							<form action="profile-edit.php" method="post" enctype="multipart/form-data">
								<div class="card-body">
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="file" class="form-control" name="profile_picture" value="<?php echo $row['profile_picture'] ?>">
										</div>
									</div>
									<div class="row mb-3">
										<div class="col-sm-3">
									...
									<div class="row mb-3">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control-plaintext" name="role" value="<?php echo $row['role'] ?>" required>
										</div>
									</div>
									<div class="row mb-4">
										<div class="col-sm-3">
										...
										<div class="col-sm-9">
											<textarea class="form-control" name="bio" rows="3"><?php echo $row['bio'] ?></textarea>
										</div>
									</div>
									<!-- Action Buttons -->
									<div class="text-end">
										<button class="btn btn-success" type="submit" name="profile-edit">Save Changes</button>
