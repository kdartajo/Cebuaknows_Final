...
<html lang="en">
	...
	<br>
        ...
        <form id="regiration_form" action="action.php"  method="post" style="padding: 50px;" enctype="multipart/form-data">
            <fieldset>
                <h2>Share Historical Content</h2>
                <div class="form-group">
                    <label for="contentTitle">TITLE</label>
                    <input type="text" class="form-control" id="contentTitle" name="contentTitle" placeholder="Enter Title" required>
                </div>
                <div class="form-group">
                    <label for="description">DESCRIPTION</label>
                    <!--<input type="text" class="form-control" id="description" name="description" placeholder="Enter Description">-->
					<textarea class="form-control" id="description" name="description" placeholder="Enter Description of Historical Site" rows="3" required></textarea>
                </div> 
                <div class="form-group"> 
                    <label for="location">LOCATION</label> 
                    <input type="text" class="form-control" id="locationDropdown" name="locationDropdown" placeholder="Location" required />
					<small>Include street, Barangay and ZIP code</small>

                    <!--<select class="form-control" id="locationDropdown" name="locationDropdown" onchange="updateLocation()">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="url" id="url" placeholder="Paste Url">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="image" id="image" placeholder="Upload Picture" required>
                </div>
				<br>
...
<script>
	 // Set the maximum file size (25 MB)
    const maxFileSize = 25 * 1024 * 1024; // 25MB in bytes

    // Get the video input element
    const videoInput = document.getElementById('video');

    // Add an event listener to check the file size when the user selects a file
    videoInput.addEventListener('change', function() {
        const file = videoInput.files[0]; // Get the first selected file
        ...
        if (file) {
            ...
            if (fileSize > maxFileSize) {
                alert("The video file is too large. Maximum allowed size is 25 MB.");
