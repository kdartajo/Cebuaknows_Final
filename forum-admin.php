<?php
	...
	if(isset($_POST['post_forum'])){
		...
		if($result){
			...
			header('location: forum-admin.php?get_content_id='. $_GET['get_content_id']);
			exit;
		}
	}
?>
										...
										<div class="card-body">
										  ...
										  <div class="d-flex justify-content-between align-items-center">
											<div class="btn-group">
											  ...
											  <a  href="forum_page-admin.php?forum_id='.$row['forum_id'].'" class="btn btn-sm btn-outline-primary"><i class="fas fa-newspaper"></i> View Forum</a>
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  ...
			  <div class="modal-body">
				<form action='forum-admin.php?get_content_id=<?php echo $_GET['get_content_id']?>' method="post">
				  <div class="mb-3">
