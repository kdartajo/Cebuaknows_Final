		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<a href="user-account-list.php" class="btn-close"></a>
				<!--<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>  Change this button to anchor tag so that it will redirect to original link address (user-account-list.php)-->
			  </div>
								...
								echo '
									<tr>
										...
										<td style="display:flex;">
											...
											<a class="btn btn-primary"  href="user-account-list.php?get_id='.$row['user_id'].'"><i class="fas fa-edit"></i></a>	
